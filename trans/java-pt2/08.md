...
我们的游戏看起来相当糟糕(我不会玩超过几分钟，然后变得无聊，回到编程)。然而，本章中的技术实际上与我们可能用来轻松创建安卓游戏的技术相同(安卓平台几乎只运行 Java 程序)。如果你对开发安卓应用感兴趣，下载并探索安卓工作室——你会发现这个 IDE 在很多方面与 Eclipse 非常相似(事实上，很长一段时间以来，Eclipse 都是安卓开发者的首选 IDE)。您还会发现安卓工作室中的GUI工具与 Eclipse 提供的非常相似。