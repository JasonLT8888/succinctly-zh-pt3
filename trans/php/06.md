...
| ![](../Images/note.png) | 注意:右上角的 X 图标是图像文件 closebutton.png，您必须自己生成或从本电子书附带的文件中获取。 |
...
| ![](../Images/note.png) | 注意:当用户单击位于工具栏上的“添加联系人”按钮时，将执行 div_show()函数；当用户单击位于“添加新联系人”对话框右上角的“关闭”按钮时，将执行 div_hide()函数。 |
