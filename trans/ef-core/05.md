...
| ![](../Images/tip.png) | 提示:请记住，这仅仅是因为我们显式地调用了 [Validator。TryValidateObject](https://msdn.microsoft.com/en-us/library/dd411772%28v=vs.110%29.aspx) ，因为 EF Core 不再自动执行验证。 |
