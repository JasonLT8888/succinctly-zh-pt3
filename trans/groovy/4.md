...
![](../images/00014.jpeg)提示:对于较小的数据或简单的操作，我倾向于使用内置的 Groovy 方法，例如每个和 findAll，但是当它变得更复杂时，我会使用流。
...
![](../images/00014.jpeg)提示:这些示例都是基于“干净”的数据，并假设 CSV 中的数字字段包含数字。如果你的数据很乱，值得用地图操作来整理一下。
