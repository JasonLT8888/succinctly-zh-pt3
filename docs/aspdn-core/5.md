...
![Figure 3-1](../Images/image018.png)

图 5-1:使用邮递员测试 REST 端点-1

![Figure 3-2](../Images/image019.png)

图 5-2:使用邮递员测试 REST 端点-2

使用 POST 创建用户(/API/user)。

![Figure 3-3](../Images/image020.png)

图 5-3:使用邮递员测试 REST 端点-3

删除用户(/API/user？id=2 使用 DELETE)。

![Figure 3-4](../Images/image021.png)
...
![Figure 3-5](../Images/image022.png)
...
![Figure 3-10](../Images/image027.png)
...
![Figure 3-11](../Images/image028.png)
...
![Figure 3-12](../Images/image029.png)
...
要在视图中使用标记助手，您必须告诉 Visual Studio 和。NET Core 框架在哪里可以找到它们。这是通过在 _ViewImports.cshtml 文件中添加引用来实现的。
...
![Figure 3-15](../Images/image032.png)
...
![Figure 3-16](../Images/image033.png)
