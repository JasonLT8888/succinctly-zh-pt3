...
| ![](../images/00009.gif) | 提示:将导入添加到代码中时，首先指定 from 名称；这将允许 Visual Studio 代码使用智能感知来自动验证组件名称。 |
...
| ![](../images/00003.gif) | 注意:您只能有一个或另一个(模板或模板 Url)。 |
...
| ![](../images/00009.gif) | 提示:在我看来，明确使用 public 关键字是不错的编程风格。 |
